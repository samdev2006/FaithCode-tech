...
const About = () => {
  return (
    <section id="about" className="py-8 bg-transparent overflow-hidden">
      <div className="container mx-auto px-6">
        ...
        >
          <div className="md:w-1/2 ">
            <h2 
              className="text-5xl font-black text-faith-light mb-6"
            >
              L'Alliance de la <span className="text-faith-blue">Vision</span> et de l'Excellence.
            </h2>
            
            <p className="text-gray-600 leading-relaxed mb-6 ">
              Chez <span className="font-bold text-faith-light">FaithCode Tech</span>, nous croyons que chaque ligne de code est une promesse tenue. Nous ne nous contentons pas de développer ; nous architecturons l'avenir de votre entreprise.
            </p>
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  <div className="mt-1 w-5 h-5 rounded-full bg-faith-orange/20 flex items-center justify-center">
                    <div className="w-2 h-2 rounded-full bg-faith-pink"></div>
                  </div>
                  <div>
                    <h4 className="font-bold text-faith-dark text-xl">{item.t}</h4>
                    <p className="text-xl text-gray-500 ">{item.d}</p>
                  </div>
                </div>
              ))}
            </div>
